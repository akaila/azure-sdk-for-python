...
DESCRIPTION:
    ...
    Demonstrates the new knowledge base / knowledge source counters on
    SearchServiceCounters. These are reported by
    SearchIndexClient.get_service_statistics() alongside the existing
    per-resource counters (indexes, indexers, data sources, etc.).

    This sample is read-only: it does not create or modify any resources.
...
def show_knowledge_resource_counters():
    # [START show_knowledge_resource_counters]
    ...
    # [END show_knowledge_resource_counters]


if __name__ == "__main__":
    show_knowledge_resource_counters()